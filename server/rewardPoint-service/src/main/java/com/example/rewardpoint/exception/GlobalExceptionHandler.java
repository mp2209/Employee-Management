package com.example.rewardpoint.exception;
...
/**
 * Centralised exception handler for rewardPoint-service.
 * Returns a consistent error envelope and avoids leaking stack traces.
 */
